...
CREATE TABLE IF NOT EXISTS Notificacao (
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_notif_usuarioFOREIGN KEY (id_usuario)  REFERENCES Usuario  (id)ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT fk_notif_denunciaFOREIGN KEY (id_denuncia) REFERENCES Denuncia (id)ON DELETE SET NULL ON UPDATE CASCADE
